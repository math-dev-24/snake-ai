...
import HumainControl from '@/components/controller/HumainController.vue'
import AIControls from '@/components/controller/AiController.vue'
...
<template>
  <div class="grid grid-cols-2 gap-2 min-h-screen">
    ...
    <!-- Grille de jeu -->
    <div class="flex-1">
      <GridSnake :grid-size="grid_size" :snake="snake.body" :apple="apple" :path="path" :show-path="show_path"
